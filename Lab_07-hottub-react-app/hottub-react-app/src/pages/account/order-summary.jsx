      ...
      <main className="max-w-7xl mx-auto px-4">
              ...
              <div className="mb-8">
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 mb-8">
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 text-sm">
                    ...
                    <div>
                      ...
                      <p className="mt-1"><span className="bg-yellow-100 text-yellow-800 text-xs font-semibold px-2 py-1 rounded">Pending</span></p>
                    </div>
                    <div>
                ...
                <section className="mb-8">
                  <h2 className="text-lg font-bold text-gray-800 mb-4 pb-2 border-b border-gray-200">Order Details</h2>
                    ...
                    <table className="w-full text-sm">
                      ...
                      <tbody className="divide-y divide-gray-100">
                        <tr>
                          <td className="py-3 px-4">
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                <p className="font-semibold text-gray-800">5-7 Person 158 Jet Spa with Stereo System</p>
                                <p className="text-xs text-gray-400 mt-1">Color: Sterling Silver<br />Shell: Pearl</p>
                              </div>
                            </div>
                          </td>
                        ...
                        <tr>
                          <td className="py-3 px-4">
                            <div className="flex items-center gap-3">
                              <img src="/assets/images/113152315_spa-566_copy.png" alt="Spa Product" className="w-16 h-16 object-cover rounded" />
                              <div>
                                <p className="font-semibold text-gray-800">TV Theater Spa - Premium Home Entertainment</p>
                ...
                <section className="mb-8">
                  <h2 className="text-lg font-bold text-gray-800 mb-4 pb-2 border-b border-gray-200">Payment Information</h2>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                      <h3 className="font-semibold text-sm text-gray-800 mb-2">Payment Method</h3>
                      <p className="text-sm text-gray-600">Credit Card (Visa ending in 4242)</p>
                    </div>
                    <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                      <h3 className="font-semibold text-sm text-gray-800 mb-2">Bank Details for Wire Transfer</h3>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <a href="/" className="bg-gray-200 hover:bg-gray-300 text-gray-800 px-8 py-3 rounded font-semibold text-sm text-center transition">CONTINUE SHOPPING</a>
                </div>
              </div>
            </main>
    </SiteLayout>
