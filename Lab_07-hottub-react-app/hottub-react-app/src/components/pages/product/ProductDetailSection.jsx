    ...
    <div className="flex flex-col lg:flex-row gap-8 mb-8">
      <div className="lg:w-3/4">
        <div className="flex flex-col md:flex-row gap-6 mb-8">
          ...
          <div className="md:w-1/2">
            ...
            <div className="flex items-center gap-2 mb-4">
              <div className="flex text-yellow-400 text-sm"><i className="fas fa-star" /><i className="fas fa-star" /><i className="fas fa-star" /><i className="fas fa-star" /><i className="fas fa-star-half-alt" /></div>
        ...
        <div className="tabs-container mb-8">
          ...
          <div id="tab-details" className="tab-content active p-6 bg-gray-50 rounded-b-lg">
            <h3 className="font-bold text-gray-800 mb-3">Product Details</h3>
            <p className="text-sm text-gray-600 mb-4">Emerald Bay XL TV DVD Stereo Hot Tub with 90 Jets</p>
            <p className="text-sm text-gray-500 mb-2">Energy Star Rated - No</p>
            <h4 className="font-bold text-gray-700 mt-4 mb-2">The Hottub B22CS30SNS</h4>
            <p className="text-sm text-gray-600 leading-relaxed">This is Photoshop's version of Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a ornare odio. Sed non mauris vitae erat consequat auctor eu in elit.</p>
            <p className="text-sm text-gray-600 leading-relaxed mt-3">Mauris in erat justo. Nullam ac urna eu felis dapibus condimentum sit amet a augue. Sed non neque elit. Sed ut imperdiet nisi.</p>
          </div>
